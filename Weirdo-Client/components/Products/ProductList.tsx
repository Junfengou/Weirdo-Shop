  ...
  return (
    <div className='mr-10'>
      <div className='flex flex-row justify-between items-center mt-2 mb-2'>
        <h1 className='mb-2 text-2xl font-bold tracking-tight text-gray-900'>Latest Products</h1>
        <Link href="/products/addproduct">
          <button type="button" className="mt-4 text-gray-900 bg-gradient-to-r from-red-200 via-red-300 to-yellow-200 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
            Add Product
          </button>
        </Link>
      </div>
